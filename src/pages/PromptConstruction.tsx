          ...
          <Card className="w-full max-w-2xl bg-white border border-border shadow-lg">
            <CardContent className="p-0">
              ...
              <div className="flex justify-between items-center p-6 border-b border-border">
                ...
                <Button variant="ghost" size="icon" onClick={() => navigate("/modules")} className="h-6 w-6 text-muted-foreground hover:text-foreground">
                  <X className="h-4 w-4" />
                </Button>
              </div>
              ...
              <div className="flex gap-8 p-8">
                ...
                <div className="flex-1">
                  ...
                  <Button onClick={handleContinue} className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded-full">
                    Continue →
                  </Button>
                </div>
              </div>
