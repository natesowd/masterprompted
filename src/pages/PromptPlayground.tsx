  ...
  const submitAnswerForThreadVersion = useCallback(
    async (threadIndex: number, versionIndex: number, promptText: string) => {
      ...
      try {
        ...
        }}}, [uploadedFiles]);const handlePromptOptimize = useCallback(async (prompt: string, ...args: string[]) => {if (!prompt.trim()) return;setWaitingForOptimization(true);
      ...
      <main className="container mx-auto px-0 py-0">
        <div className="flex gap-8 h-[calc(100vh-8rem)]">
          <div className="min-w-[317px] 2xl:min-w-[346px]">
            <div className="sticky top-4 py-[10px] px-[6px]">
              <PromptControls {...{
                parameters,
