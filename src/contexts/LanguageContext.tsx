  ...
  en: {
    ...
    intro: {
      ...
      base: {
        ...
        startNow: 'Start Now',
        selectLearning: 'Select Learning'
      }
    },
    nextWord: {
      intro: {
...
d) Perform a "Delta Check": Remove any edits that are stylistic rather than functional to ensure the "Minimum Amount of Change" rule is met.`,
    ...
    components: {
      ...
      chatAnswer: {
        ...
        compare: 'Compare',
        comparePickBase: 'Pick a version to compare against',
...
d) Realizar una «comprobación delta»: eliminar cualquier edición que sea estilística en lugar de funcional para garantizar que se cumple la regla de la «cantidad mínima de cambio».`,
    ...
    components: {
      ...
      promptControls: {
        ...
        sendOptimizedPrompt: 'Optimizar Prompt',
      ...
      chatAnswer: {
        ...
        compare: 'Comparar',
        comparePickBase: 'Elige una versión para comparar',
        changeBase: 'Cambiar base',
        version: 'Versión',
        cancel: 'Cancelar',
      },
      compareView: {
        loading: 'Mapeando bloques semánticos…',
        error: 'Error en la comparación',
        currentLegend: 'Actual',
        comparedLegend: 'Comparado',
        noMatch: 'Sin coincidencia',
        swapAria: 'Haz clic para intercambiar con la contraparte',
      },
      chatBody: {
